            ...
            <div className="grid md:grid-cols-2 items-center gap-10 max-w-5xl max-md:max-w-md mx-auto">
                ...
                <div className="max-md:text-center">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4 text-center">
                        ...
                        <a
                            href="#"
                            className="block w-full rounded-full bg-[#8F71E1] px-3 py-2 text-3xl font-medium text-white shadow hover:text-white focus:outline-none focus:ring active:text-[#8F71E1] sm:w-auto"
                        >
                            <FiArrowUpRight />
                        </a>
                    </div>
